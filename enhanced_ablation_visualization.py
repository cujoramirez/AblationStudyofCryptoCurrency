...
def create_radar_chart(df, output_dir):
    ...
    try:
        ...
        # Create a figure with multiple subplots - increase size for better spacing and readability
        ...
        for i, country in enumerate(countries):
            ...
            ax.plot(angles, values, linewidth=2.5, linestyle='solid', label=country, color='royalblue')
        ...
        plt.tight_layout()
        plt.subplots_adjust(wspace=1.0)  # Increase spacing between subplots
